...
*/
defined('_JEXEC' ) or die( 'Direct Access to this location is not allowed.');global $mosConfig_live_site;
// Global
$moduleclass_sfx = $params->get('moduleclass_sfx', '');
$jquery = $params->get('jquery', 1);
$pretext = $params->get('pretext', '');
$btntxt = $params->get('btntxt', 'Donate');
// Webmoney
...
$wm_descpay = $params->get('wm_descpay','Donate Author');
// Yandex
...
<?php if($jquery) {?>
<script type="text/javascript" src="<?php echo JURI::base();?>/modules/mod_amoney/js/jquery.js"></script>
<?php }?>
...
<div id="poweredby">
	Powered by <a href="http://adeptsite.info" title="Visit Author!" target="_blank">Adeptus Donate</a>&nbsp;|&nbsp;<a href="http://www.gost743.ru" target="_blank" title="Такси 743">Такси 743</a>
</div>
